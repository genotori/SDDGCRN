...
def data_loader(X, Y, batch_size, shuffle=True, drop_last=True, pad_with_last_sample=False):
...
def get_dataloader(args, normalizer = 'std', tod=False, dow=False, weather=False, single=True):
    ...
    test_dataloader = data_loader(x_test, y_test, args.batch_size, shuffle=False, drop_last=False, pad_with_last_sample=True)
